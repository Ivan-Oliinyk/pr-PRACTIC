...
export class ActivitiesService {
  ...
  async create(createdBy: User, activityData: CreateActivityDto) {}
  // find(activity: Partial<Activity>) {
  //   return this.ActivityModel.find(activity)
  //     .sort('ordering')
  //     .lean();
  // }
  ...
  async reorderActivityInsideRoutine(data: ReorderActivity) {}
