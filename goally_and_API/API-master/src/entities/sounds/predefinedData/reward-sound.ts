...
export const rewardSound: SoundTypeDto[] = [
  {
    event: 'Reward Redeem',
    volume: 100,
    audioList: [
      ...
      },
      {
        name: 'Applause 1',
        url:
          'https://goally-files.s3.amazonaws.com/predefinedSounds/applause_1.mp3',
        isSelected: false,
      },
      {
        name: 'Applause 2',
        url:
          'https://goally-files.s3.amazonaws.com/predefinedSounds/applause_2.mp3',
        isSelected: false,
      },
      {
        name: 'Complete',
